...
def test_update_module_list(full_update, test_client: TestClient, db_test_session: Session, latest_test_module_config: dict):
    test_client.get("/v1/submodule/update_module_list", params={"full_update": full_update})

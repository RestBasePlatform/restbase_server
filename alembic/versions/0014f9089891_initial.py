...
def upgrade():
    ...
    op.create_table('access_object_type',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id', 'name')
    )
    op.create_table('access_owner_type',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id', 'name')
    )
    ...
    sa.ForeignKeyConstraint(['access_object_type_id'], ['access_object_type.id'], ),
    sa.ForeignKeyConstraint(['access_owner_type_id'], ['access_owner_type.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['host_secret_id'], ['secret.id'], ),
    ...
    sa.ForeignKeyConstraint(['connection_data_id'], ['database_connection.id'], ),
    sa.ForeignKeyConstraint(['submodule_id'], ['submodule.id'], ),
    sa.PrimaryKeyConstraint('name')
    )
    op.create_table('database_list',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('installation', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['installation'], ['installation.name'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('schema_list',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('database', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['database'], ['database_list.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('table_list',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('schema', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['schema'], ['schema_list.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['table'], ['table_list.id'], ),
    sa.PrimaryKeyConstraint('id')
    )

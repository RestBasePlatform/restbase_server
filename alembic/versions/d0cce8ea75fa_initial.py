...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['password'], ['secret.id'], ),
    sa.ForeignKeyConstraint(['ssh_key'], ['secret.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['credential_id'], ['server_credentials.id'], ),
    sa.PrimaryKeyConstraint('name')
    )
    ...
    sa.ForeignKeyConstraint(['database'], ['database.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
